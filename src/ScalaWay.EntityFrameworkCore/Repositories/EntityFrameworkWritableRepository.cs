...
{
    public abstract class EntityFrameworkWritableRepository<TAggregateRoot> : EntityFrameworkRepository<TAggregateRoot>, IWritableRepository<TAggregateRoot>
        where TAggregateRoot : class, IAggregateRoot
    {
        protected EntityFrameworkWritableRepository(DbContext dbContext) : base(dbContext)
        {
        }
